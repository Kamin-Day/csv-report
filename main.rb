...
#holds catagory totals in array
	@cataTotalsSonia = getCatagoryTotal("Sonia")
	@cataTotalsPriya = getCatagoryTotal("Priya")
#holds transaction averages in array
	@cataAvgsSonia = getAverages("Sonia")
	@cataAvgsPriya = getAverages("Priya")
